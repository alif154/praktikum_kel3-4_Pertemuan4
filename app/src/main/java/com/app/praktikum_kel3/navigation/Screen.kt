package com.app.praktikum_kel3.navigation
...
sealed class Screen(val route: String) {
     ...
     * @see com.app.praktikum_kel3.screen.HomeScreen
     */
     ...
     * @see com.app.praktikum_kel3.screen.ProfileScreen
     */
    object Profile : Screen(route = "profile")

    /**
     * Objek untuk halaman Login.
     * @see com.app.praktikum_kel3.screen.LoginScreen
     */
    object Login : Screen(route = "login")

    /**
     * Objek untuk halaman Register.
     * @see com.app.praktikum_kel3.screen.RegisterScreen
     */
